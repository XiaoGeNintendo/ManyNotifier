...
/**
 * HYSBZ submission object.
 * 
 * @author XGN
 *
 */
public class HYSBZSubmission {
	public int RunID;
	public String User;
	public int PID;
	 ...
	 * 22:40:40</td> </tr>
	 */
	public HYSBZSubmission(Element tds) throws Exception {

		Elements son = tds.children();
		RunID = Integer.parseInt(son.get(0).text());
		User = son.get(1).text();
		PID = Integer.parseInt(son.get(2).text());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HYSBZSubmission other = (HYSBZSubmission) obj;
		if (Code_Length == null) {
	...
	public String toString() {
		return "HYSBZSubmission [RunID=" + RunID + ", User=" + User + ", PID=" + PID + ", Result=" + Result
